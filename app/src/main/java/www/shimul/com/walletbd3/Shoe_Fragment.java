...
public class Shoe_Fragment extends Fragment {

    private static final String TAG="Shoe Fragment";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View shoeView=inflater.inflate(R.layout.shoe_fragment,container,false);

        recyclerView=shoeView.findViewById(R.id.shoeRecyclerId);
